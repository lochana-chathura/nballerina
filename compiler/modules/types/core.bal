...
public final SemType READONLY_OR_UNDEF = union(READONLY, UNDEF);
...
final Atom CELL_ATOM_TOP_OR_UNDEF = { index: 8, atomicType: CELL_ATOMIC_TOP_OR_UNDEF };
final Atom CELL_ATOM_RO_OR_UNDEF = { index: 9, atomicType: CELL_ATOMIC_RO_OR_UNDEF };
