...
type R12 record { int a; };

type R21 record {| int a?; |};
type R22 record { int a?; };


type R31 record {| int? a; |};
type R32 record { int? a; };


type R41 record {| int a?; string b; |};
type R42 record { int a?; string b; };

type R51 record {| int a; string b; |};
type R52 record { int a; string b; };

type R61 record {| int a?; string b?; |};
type R62 record { int a?; string b?; };


type R71 record {| int|string a?; |};
type R72 record { int|string a?; };

type R81 record {| int|string a?; string|boolean b?; boolean c?; |};
type R82 record { int|string a?; string|boolean b?; boolean c?; };


type R91 record {| int? a?; |};
type R92 record { int? a?; };
